		...
		<div class="max-w-md mx-auto  border border-neutral-800 shadow-lg rounded-lg p-8">
			...
			<form action="" method="post">
				<div class="mb-4">
					...
					<input autocomplete="off" type="text" name="username" class="border border-gray-600 bg-transparent text-neutral-200 placeholder:text-sm p-2 w-full rounded <?= form_error('username') ? 'border-red-500' : '' ?>"
				...
				<div class="mb-6">
					...
					<input autocomplete="off" type="password" name="password" class="border border-gray-600 bg-transparent text-neutral-200 placeholder:text-sm p-2 w-full rounded <?= form_error('password') ? 'border-red-500' : '' ?>"
